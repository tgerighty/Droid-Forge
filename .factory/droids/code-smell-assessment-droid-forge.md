...
Task tool with subagent_type="code-smell-assessment-droid-forge" \
  ...
  prompt "Scan entire codebase for code smells, prioritize by impact, create /tasks/tasks-code-smells-DATE.md with detailed refactoring tasks"
...
Task tool with subagent_type="code-refactoring-droid-forge" \
  ...
  prompt "Fix code smells from /tasks/tasks-code-smells-DATE.md: LargeClass UserService and LongMethod processOrder()"
